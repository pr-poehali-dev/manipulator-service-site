...
const galleryImages = [
  {
    id: 1,
    src: "https://images.unsplash.com/photo-1610455677000-ef5db351994c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    alt: "Манипулятор перевозит строительные материалы",
    category: "Перевозка"
  },
  {
    id: 2,
...
const categories = ["Все", "Перевозка", "Погрузка", "Монтаж", "Разгрузка", "Эвакуация"];
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-manipulator-gray-dark max-w-3xl mx-auto">
            Фотографии выполненных нами работ по перевозке, погрузке и монтажу различных грузов
          </p>
        </div>
