        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-lg text-manipulator-gray-dark mb-8">
              Наши специалисты ответят на все ваши вопросы, рассчитают стоимость и подберут оптимальный манипулятор для ваших задач.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+79001234567" className="text-manipulator-primary hover:text-manipulator-secondary transition-colors">
                    +7 (900) 123-45-67
                  </a>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:info@manipulator-service.ru" className="text-manipulator-primary hover:text-manipulator-secondary transition-colors">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-manipulator-primary text-white hover:bg-manipulator-secondary hover:text-manipulator-primary p-3 rounded-full transition-colors">
