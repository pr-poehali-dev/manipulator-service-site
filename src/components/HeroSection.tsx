      ...
      <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
        <div className="max-w-2xl animate-fadeIn">
          ...
          <p className="text-xl mb-8 text-gray-100">
            Быстрая подача техники, опытные операторы и выгодные цены.
            Предоставляем услуги по городу Клин и Клинскому району, выполняем
            работу любой сложности. Работаем с частными и юридическими лицами.
          </p>
