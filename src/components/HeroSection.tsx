  ...
  return (
    <section className="hero" id="hero">
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://images.unsplash.com/photo-1588495752527-77d65c21f7d1?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')" 
        }}
      />
      ...
      <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
        <div className="max-w-2xl animate-fadeIn">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
            Услуги манипулятора <span className="text-manipulator-secondary">в вашем городе</span>
          </h1>
          
          <p className="text-xl mb-8 text-gray-100">
            Быстрая подача техники, опытные операторы и выгодные цены на все виды работ с использованием крана-манипулятора
          </p>
